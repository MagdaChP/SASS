...
gulp.task('sass', function() { 
  return gulp.src('scss/main.scss') //znajdź plik style.css
...
gulp.task('watch', function(){
  gulp.watch('scss/**/*.scss', ['sass']); /*które katalogi powinien oglądać, tutaj nazwa folderu to sass(tak nazywa się nasz folder z plikami sassa) */
})
